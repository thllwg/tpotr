...
#
# #Pipeline
# c_wine <- TPOTRegressor(verbosity=2, max_time_mins=10, population_size=50)
...
# data_concrete <- read.csv("./sample_data/Concrete_Data.csv", header = TRUE, sep = ";")
#
# #Preprocessing
...
#
# #Pipeline
# c_concrete <- TPOTRegressor(verbosity=2, max_time_mins=20, population_size=50)
